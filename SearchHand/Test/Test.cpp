...
bool GrabSearchEngineTest(const std::wstring &strRequest)
{
...
int _tmain(int /*argc*/, _TCHAR** /*argv*/)
{
	...
	GrabSearchEngineTest(L"https://www.google.com.hk/search?q=testx");//ÈôÄúÔÚ”µÃëƒÈÈÔÎ´ÄÜ×Ô„ÓÌøÞD£¬Õˆüc“ôß@ÑY¡£
    //CompleteTest();
	return 0;
}
